Feature: Manter a temparatura da sala de aula

  Scenario Outline: Manter a temparatura da sala
    Given Eu quero controlar a temperatura da sala
    When Os sensores detectam a quantidade de pessoas na sala "<Sensor_Interno1>", "<Sensor_Interno2>", "<Sensor_Interno3>"
